...
int main(void)
{
	...
	lcd_showChinChar(160, 200, 0, c_YELLOW);
	lcd_showChinChar(176, 200, 1, c_YELLOW);
	lcd_showChinChar(192, 200, 2, c_YELLOW);
	...
	lcd_showChinChar(160, 100, 3, c_YELLOW);
	lcd_showChinChar(176, 100, 4, c_YELLOW);
	lcd_showChinChar(192, 100, 5, c_YELLOW);
}
